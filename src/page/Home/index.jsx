          ...
          <section className="hm-main-content-wrapper">
            <div className="hm-main-content">
              ...
              <div className="hm-product-desc">
                <h1 className="hm-product-desc-title">
                  Mid-Century 1929 Sofa with Pilow
                </h1>
                <p className="hm-product-desc-body">
                  Donec nunc nunc, gravida vitae diam vel, varius interdum erat.
                  Quisque a nunc vel diam auctor commodo. Curabitur blandit
            ...
            <div className="hm-footer-content">
              <div className="hm-footer-body">
                <p className="hm-footer-desc">
                  ...
                  questions which they replied quickly to answer. If I could
                ...
                <p className="hm-footer-desc-footer">
