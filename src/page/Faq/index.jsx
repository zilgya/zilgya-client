                        ...
                        <div className='faq-shopping-questions'>
                            ...
                            <div className='body-shopping-questions-wrapper'>
                                <div className='body-shopping-questions'>
                                    <div className='body-shopping-questions-title'>Do you ship worldwide?</div>
                                    <div>This is the third article of a three-part series. I’m illustrating the marketing challenges of PrescottWeddings.com, a small business. If you don’t remember anything else about marketing, remember this: Frequency is king.</div>
                                </div>
                                <div className='body-shopping-questions'>
                                    <div className='body-shopping-questions-title'>How can I use a coupon code?</div>
                                    <div>This is the third article of a three-part series. I’m illustrating the marketing challenges of PrescottWeddings.com, a small business. If you don’t remember anything else about marketing, remember this: Frequency is king.</div>
                                </div>
                            </div>
                            <div className='body-shopping-questions-wrapper'>
                                <div className='body-shopping-questions'>
                                    <div className='body-shopping-questions-title'>Do you offer gift-vouchers?</div>
                                    <div>This is the third article of a three-part series. I’m illustrating the marketing challenges of PrescottWeddings.com, a small business. If you don’t remember anything else about marketing, remember this: Frequency is king.</div>
                                </div>
                                <div className='body-shopping-questions'>
                                    <div className='body-shopping-questions-title'>How can I request a refund?</div>
                                    <div>This is the third article of a three-part series. I’m illustrating the marketing challenges of PrescottWeddings.com, a small business. If you don’t remember anything else about marketing, remember this: Frequency is king.</div>
                                </div>
                            </div>
                        </div>
